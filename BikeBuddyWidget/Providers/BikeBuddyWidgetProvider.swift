...
struct Provider: IntentTimelineProvider {
    ...
    func getTimeline(
        ...
        BikeRentalStationApiService.shared.fetchStationFromApi(idToFetch) { bikeRentalStation in
            if let bikeRentalStationUnwrapped = bikeRentalStation {
                ...
                Log.e("Station received from API is nil")
            }
        }
    }
}
