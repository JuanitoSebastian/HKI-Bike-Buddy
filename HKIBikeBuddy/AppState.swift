...
extension AppState {
    ...
    /// First the curent nearby stations are fetched from the API. From this data new stations are created and
    /// existing stations updated. Then the rest of the stations in the store are updated
    func fetchFromApi() {
